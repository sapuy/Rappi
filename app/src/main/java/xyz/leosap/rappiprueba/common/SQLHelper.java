...
{
    public static String CREATE_TABLE_TEMA = "CREATE TABLE tema (id TEXT, title TEXT,header_title TEXT, display_name TEXT, description TEXT, created NUMBER, public_description TEXT, banner_img TEXT, header_img TEXT, icon_img TEXT, url TEXT, key_color TEXT, submit_text TEXT,subscribers NUMBER,public_description_html TEXT,description_html TEXT )";
